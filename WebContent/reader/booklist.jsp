            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class=""><a href="${pageContext.request.contextPath}/reader/index.jsp"><i class="icon mdi mdi-home"></i><span>LG书店</span></a>
                  </li>
                  <li class="active"><a href="${pageContext.request.contextPath}/ReaderBook"><i class="icon mdi mdi-book"></i><span>书籍列表</span></a>
                  </li>
                  </li>
                </ul>
              </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
      	...
      	btn.onclick = function(){
      		...
      		var url = "BookSearch?book="+bookname+"&do=reader";
      		form.action=url;
      		form.method="post";
