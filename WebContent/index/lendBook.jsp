            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li  class="active"><a href="${pageContext.request.contextPath}/index/lendBook.jsp"><i class="icon mdi mdi-book"></i><span>借书管理</span></a>
                  </li>
	      ...
	      <div class="main-content container-fluid">
	            <div class="col-md-6" center>
	              <div class="card card-border-color card-border-color-primary">
	                <div class="card-header card-header-divider">书籍借出<span class="card-subtitle"></span></div>
	                <div class="card-body">
	                  <form action="${pageContext.request.contextPath}/LendBook" method="post">
	                    <div class="form-group">
	                      <label>借书人ID</label>
	                      <input id="uid" name="uid" type="text" placeholder="请输入借书人证号" class="form-control">
	                    </div>
	                    <div class="form-group">
	                      <label>书籍ISBN</label>
