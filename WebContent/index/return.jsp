            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li  class="active"><a href="${pageContext.request.contextPath}/index/return.jsp"><i class="icon mdi mdi-book"></i><span>还书管理</span></a>
                  </li>
	                ...
	                <div class="card-body">
	                  <form action="${pageContext.request.contextPath}/ReturnBook" method="post">
	                    <div class="form-group">
	                      <label>归还人ID</label>
	                      <input id="uid" name="uid" type="text" placeholder="请输入借阅者证号" class="form-control">
	                    </div>
	                    <div class="form-group">
	                      <label>书籍ISBN</label>
